...
if max_or_mean == "max_special":
    ...
    labels = ["turkish_nationalism", "conservatism", "islamism", "liberalism", "kemalism"] # ideology_1
    # labels = ["social_democracy", "socialism", "feminism", "environmentalism", "kurdish_national_movement", "secularism"] # ideology_2
